...
const Reviews = ({ itemId, placeOwnerId }) => {
  ...
  const { authUser, isOwner } = userAuth();
  ...
  const handleReplySubmit = async (data) => {
    try {
      await axios.post(`${API_BASE}/reviews/${replyingTo}/reply`, {
    ...
    <div>
      ...
      {authUser && authUser.role === "user" && (
        ...
        >
          ...
          <button
            type="submit"
            className="mt-2 px-4 py-2 bg-[#FF7B54] text-white rounded-lg text-sm"
          >
            Submit Review
          </button>
        </form>
            ...
            <div key={review._id} className="text-sm border-b pb-3">
              ...
              {replyingTo === review._id && (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="text-xs px-2 py-1 bg-green-500 text-white rounded-md mt-1"
                  >
                    Post Reply
                  </button>
                </form>
