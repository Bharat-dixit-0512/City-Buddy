    ...
    <div className="min-h-screen bg-gray-50 text-slate-900 px-6 py-12 flex justify-center">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-2xl p-8">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-2">3. Services Provided</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-2">6. Reviews & Content</h2>
            <p>
              Users may post reviews and ratings. By posting content, you grant
              CityBuddy a non-exclusive, royalty-free license to use and
              distribute that content. We may remove content that violates these
              Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              CityBuddy integrates with third-party APIs (like Google Maps).
          ...
          <section>
            ...
            <p>
              ...
              <br /> <a className="hover:text-blue-600" href="mailto:komal.patel_cs23@gla.ac.in "  target="_blank">📧 komal.patel_cs23@gla.ac.in </a><span>(Team Leader)</span>
              <br /> <a className="hover:text-blue-600" href="mailto:avni.yadav_cs23@gla.ac.in " target="_blank">📧 avni.yadav_cs23@gla.ac.in</a>
              <br /> <a className="hover:text-blue-600" href="mailto:bharat.dixit1_cs23@gla.ac.in " target="_blank">📧 bharat.dixit1_cs23@gla.ac.in</a>
            </p>
          </section>
        </div>
      </div>
