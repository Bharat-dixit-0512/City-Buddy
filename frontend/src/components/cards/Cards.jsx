...
const Cards = ({ item, onItemClick }) => {
  ...
  return (
    <div 
      className="h-full bg-white rounded-2xl shadow-lg hover:shadow-xl border transition-all duration-300 overflow-hidden transform hover:-translate-y-1 cursor-pointer" 
